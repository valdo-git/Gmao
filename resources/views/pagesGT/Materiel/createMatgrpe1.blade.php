...
<form class="form-horizontal" method="POST" action="{{ route('Materiels.store') }}" accept-charset="UTF-8">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-2 text-right control-label col-form-label" >*Kilométrage initial :  </label>
            <div class="col-sm-6">
                <input class="form-control" name="kilometrageInit" type="number" id="kilometrageInit" required>
            </div>
        </div>
