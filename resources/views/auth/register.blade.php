            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">ROLE_ID</label>
                            <div class="col-md-6">
                                <input id="role_id" type="number" class="form-control" name="role_id" value="" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Matricule</label>
                            <div class="col-md-6">
                                <input id="matricule" type="text" class="form-control" name="matricule" value="" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="statut" type="text" class="form-control" name="statut" value="{{ old('statut') }}" required>
                            </div>
                        </div>
