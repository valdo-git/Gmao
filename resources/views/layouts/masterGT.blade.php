            ...
            <ul class="navbar-nav animate side-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="demo3">
                        <a href="{{ route('Dossiers.create') }}" class="nav-link">Lancer un Dossier</a>
                        <a href="{{ route('Dossiers.index',['operateur'=>'GT']) }}" class="nav-link">Consulter les Dossiers</a>
                    </div>
                </li>

                <li class="nav-item">
                    <a href="#demo3ter" class="nav-link" data-toggle="collapse" data-parent="#MainMenu">
                        <i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;Techniciens &nbsp;<i class="fa fa-caret-down"></i></a>
                    <div class="collapse" id="demo3ter">
                        <a href="{{ route('Techniciens.create') }}" class="nav-link">Ajouter un technicien</a>
                        <a href="{{ route('Techniciens.index') }}" class="nav-link">Consulter la liste</a>
                    </div>
                </li>
