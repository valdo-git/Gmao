        ...
        <div class="col-sm-6">
            <div class="card text-white bg-dark text-center pt-2 mb-4">
                <div class="card-body card-title">
                    ...
                    <a href="{{route('homeGTMatIndispo')}}"><h6  class="text-light">3 matériels indisponibles</h6></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card text-white bg-primary text-center pt-2 mb-4">
                <div class="card-body card-title">
                    ...
                    <a href="{{route('homeGTOTouverts')}}"><h6  class="text-light">2 ordres de travail ouverts</h6></a>
        ...
        <div class="col-sm-6">
            <div class="card text-white bg-success text-center py-2 mb-4">
                <div class="card-body card-title">
                    ...
                    <a href="{{route('Ordres.index')}}"><h6  class="text-light">4 ordres de travail en attente</h6></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card text-white bg-danger text-center py-2 mb-4">
                <div class="card-body card-title">
                    ...
                    <a href="{{route('Dossiers.index',['operateur'=>'GT'])}}"><h6  class="text-light">2 pannes</h6></a>
                </div>
            </div>
        </div>
        <div class="clearfix"> </div>
